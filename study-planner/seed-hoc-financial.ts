...
const DIR = path.join(process.cwd(), 'seed-hoc-financial');
...
async function seed() {
    ...
    const entry = {
        title: "HOC Financial Powers (Part 1): Establishment, Office Expenses & Rent",
        slug: "hoc-fp-part1",
        rule_number: "Schedule II-A, Sl. No. 1–11, 13",
        act_name: "DFPR 2024",
        category: "Rule",
    ...
    console.log("Seeding HOC Financial Powers (Part 1)...");
    ...
    console.log("✅ Seed completed! HOC Financial Powers Part 1 is now live.");
    process.exit(0);
}
