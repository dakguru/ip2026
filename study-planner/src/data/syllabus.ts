...
export const SYLLABUS_DATA: Topic[] = [
    ...
    { id: 'p3-est-5-1', title: 'FR & SR - General Rules', category: 'Paper III', type: 'heavy', duration: 1, tips: ["Fundamental Rules (FR) - General Rules.", "Service conditions."] },
    { id: 'p3-est-5-2', title: 'FR & SR - TA Rules', category: 'Paper III', type: 'heavy', duration: 1, tips: ["Supplementary Rules (SR) - TA Rules."] },
    { id: 'p3-est-5-3', title: 'FR & SR - DA, DR & HRA Rules', category: 'Paper III', type: 'heavy', duration: 1, tips: ["DA, DR and HRA Rules."] },
