...
const UPDATES_DATA: UpdateGroup[] = [
    {
        ...
        items: [
            {
                title: "✨ PDF Notes Updated: Manual of Office Procedure & CCS (Revised Pay) Rules",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Manual of Office Procedure</strong> and <strong className="text-violet-600 dark:text-violet-400">Central Civil Services (Revised Pay) Rules, 2016</strong> PDF Notes for the <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> course mode!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Manual of Office Procedure</strong> and <strong>7th CPC Central Civil Services (Revised Pay) Rules, 2016</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "✨ PDF Notes: The PO Regulations, 2024 Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">The Post Office Regulations, 2024</strong> PDF Notes for both <strong className="text-zinc-900 dark:text-zinc-100">LDCE IP</strong> and <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> course modes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    {"Updated \"The Post Office Regulations, 2024\" PDF Notes as per amendments/updates incorporated upto \"Post Office (Sixth Amendment) Regulations, 2026 — S.O. 4241(E) dated 31.07.2026, w.e.f. 01.08.2026 & Parcel Directorate clarification No. 39-09/2025-PD dated 05.08.2026\""}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {
                title: "✨ PDF Notes: POSH Act, 2013 Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Sexual Harassment of Women at Workplace Act, 2013</strong> PDF Notes for both <strong className="text-zinc-900 dark:text-zinc-100">LDCE IP</strong> and <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> course modes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    },
    {
        ...
        items: [
            ...
            {
                title: "✨ PDF Notes: Complaint & Grievance Handling Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Guidelines and instructions on complaint grievances handling in Department of Posts</strong> PDF notes for the <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> Course mode!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Complaint & Grievance Handling</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "✨ PDF Notes: Manual for Procurement of Goods & Services Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Manual for Procurement of Goods & Services</strong> PDF notes for the <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> Course mode!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Manual for Procurement of Goods & Services</strong> (Part I, II & III).
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {
                title: "✨ PDF Notes: Instructions on maintenance of APAR Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Instructions issued by Directorate and DoP&T on maintenance of APAR</strong> PDF notes for the <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> Course mode!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Maintenance of Annual Performance Assessment Report (APAR)</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {
                title: "✨ PDF Notes: Government Savings Promotion Act, 1873 Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Government Savings Promotion Act, 1873</strong> PDF notes for both <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> and <strong className="text-zinc-900 dark:text-zinc-100">LDCE IP</strong> Course modes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>Government Savings Promotion Act, 1873</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "✨ PDF Notes: PMLA Act, 2002 Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">PMLA Act, 2002</strong> PDF notes for both <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> and <strong className="text-zinc-900 dark:text-zinc-100">LDCE IP</strong> Course modes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>PMLA Act, 2002</strong> (Prevention of Money Laundering Act, 2002 and its Amendments).
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {
                title: "✨ PDF Notes: Annual Reports and Book of Information Updated",
                desc: (
                    <div className="space-y-4">
                        <p className="text-zinc-700 dark:text-zinc-300">
                            We have updated the <strong className="text-violet-600 dark:text-violet-400">Annual Reports and Book of Information</strong> PDF notes for both <strong className="text-zinc-900 dark:text-zinc-100">PS Group B</strong> and <strong className="text-zinc-900 dark:text-zinc-100">LDCE IP</strong> Course modes!
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-violet-900/20 dark:to-fuchsia-900/20 p-4 rounded-xl border border-violet-200 dark:border-violet-800/50 shadow-sm relative overflow-hidden">
                                ...
                                <p className="text-zinc-800 dark:text-zinc-200 text-[12px] font-medium leading-relaxed relative z-10">
                                    Updated PDF Notes on <strong>ANNUAL REPORTS AND BOOK OF INFORMATION</strong> for the years 2024-25 and 2025-26.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-xl border border-blue-100 dark:border-blue-800/50">
                                <p className="font-bold text-blue-700 dark:text-blue-300 text-[10px] uppercase tracking-wide">LDCE IP & PS Group B</p>
        ...
        items: [
            {
                ...
                desc: (
                    <div className="space-y-4">
                        <p>Updated <strong>CS (Medical Attendance) Rules, 1944</strong> PDF Notes for PS Group B Course Mode.</p>
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-indigo-50/50 dark:bg-indigo-900/10 p-3 rounded-xl border border-indigo-100 dark:border-indigo-800/50">
                                ...
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">Latest study materials with all recent amendments on medical attendance rules.</p>
                            </div>
                        </div>
                    </div>
                )
    ...
    },
    {
        ...
        items: [
            {
                title: "📑 Current Affairs June 2026 PDF Integrated",
                desc: (
                    <div className="space-y-4">
                        <p>We have integrated the <strong>June 2026 Current Affairs Monthly Digest</strong> PDF sourced from Adda247!</p>
    ...
    },
    {
        ...
        items: [
            {
                title: "📝 Weekly Mock Test Updates & PDF Notes",
                desc: (
                    <div className="space-y-4">
                        <p><strong>Added Postal Manual Vol - VIII</strong> as a new test topic for the <strong>LDCE IP Weekly Mock Test - S2-07</strong>.</p>
                        <p><strong>Updated PDF Notes</strong> on <strong>Postal Manual Volume IV</strong> for both LDCE IP and PS Group B Course modes.</p>
                    </div>
                )
            }
        ]
        ...
        items: [
            {
                ...
                desc: (
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-xl border border-blue-100 dark:border-blue-800/50">
                                <p className="font-bold text-blue-700 dark:text-blue-300 text-[10px] uppercase tracking-wide">Paper I & Paper III Notes</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">Updated <strong>PO Small Savings Schemes</strong>, <strong>Consolidation of Products</strong>, <strong>FHB Vol I & II</strong>, and <strong>Manual for Procurement</strong>.</p>
                            </div>
                        </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "📚 PDF Notes: CCS Commutation, LTC & CGEGIS Rules Updated",
                desc: (
                    <div className="space-y-4">
                        <p>We have updated the PDF notes for <strong>CCS (Commutation of Pension) Rules, 1981</strong>, <strong>CCS (LTC) Rules, 1988</strong>, and <strong>CGEGIS 1980</strong> to their latest versions!</p>
                        
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-emerald-50/50 dark:bg-emerald-900/10 p-3 rounded-xl border border-emerald-100 dark:border-emerald-800/50">
                                <p className="font-bold text-emerald-700 dark:text-emerald-300 text-[10px] uppercase tracking-wide">Major Rules Update</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">The notes for Commutation of Pension, Leave Travel Concession, and CGEGIS have been fully revised. They are now available in the Digital Library.</p>
                            </div>
                        </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "📚 PDF Notes: GST Act, 2017 Updated",
                desc: (
                    <div className="space-y-4">
                        <p>We have updated the <strong>Goods and Services Tax (GST) Act, 2017 (Brief Notes)</strong> for the <strong>PS Group B</strong> course mode!</p>
                        
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-amber-50/50 dark:bg-amber-900/10 p-3 rounded-xl border border-amber-100 dark:border-amber-800/50">
                                <p className="font-bold text-amber-700 dark:text-amber-300 text-[10px] uppercase tracking-wide">GST Act, 2017</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">The notes have been updated to the latest revision. File size is now 0.8 MB. Additionally, the Detailed Notes version has been removed from this section to streamline preparation.</p>
                            </div>
                        </div>
    ...
    },
    {
        ...
        items: [
            {
                title: "📚 PDF Notes: CVC Guidelines on Public Procurement Updated",
                desc: (
                    <div className="space-y-4">
                        <p>We have updated the <strong>CVC guidelines on Public procurement, guide-lines and instructions on e-procurement</strong> PDF notes for the <strong>PS Group B</strong> course mode to the latest official version!</p>
                        
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-emerald-50/50 dark:bg-emerald-900/10 p-3 rounded-xl border border-emerald-100 dark:border-emerald-800/50">
                                <p className="font-bold text-emerald-700 dark:text-emerald-300 text-[10px] uppercase tracking-wide">CVC Guidelines on Public Procurement</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">The notes have been updated with the latest instructions and e-procurement guidelines. File size is now 4.2 MB.</p>
                            </div>
                        </div>

                        <p className="pt-1 text-[11px] text-emerald-600 dark:text-emerald-400 font-bold flex items-center gap-1">
                            <span>🚀</span> Access now in the Notes section under Paper I!
                        </p>
                    </div>
                )
            }
    ...
    },
    {
        ...
        items: [
            {
                title: "📚 PDF Notes: Postal Manual Volume VI Updated",
                desc: (
                    <div className="space-y-4">
                        <p>We have updated the <strong>Postal Manual Volume VI (Part I, II & III)</strong> PDF notes to the latest version!</p>
                        
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-amber-50/50 dark:bg-amber-900/10 p-3 rounded-xl border border-amber-100 dark:border-amber-800/50">
                                <p className="font-bold text-amber-700 dark:text-amber-300 text-[10px] uppercase tracking-wide">Postal Manuals</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">The notes now reflect the most recent changes and clarifications. The file size has been updated accordingly.</p>
                            </div>
                        </div>
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                desc: (
                    <div className="space-y-4">
                        <p>We have updated the <strong>Recruitment Rules relating to various cadres in D/o Posts</strong> PDF notes for PS Group B Course Mode!</p>
                        
                        <div className="grid grid-cols-1 gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-3">
                            <div className="bg-sky-50/50 dark:bg-sky-900/10 p-3 rounded-xl border border-sky-100 dark:border-sky-800/50">
                                <p className="font-bold text-sky-700 dark:text-sky-300 text-[10px] uppercase tracking-wide">Paper I (PS Group B)</p>
                                <p className="text-zinc-600 dark:text-zinc-400 mt-1 text-[11px]">Corrected comprehensive notes covering the Recruitment Rules relating to various cadres in D/o Posts.</p>
                            </div>
                        </div>
...
// Exported for use in HomepageMarquee — updates from the last 3 days
