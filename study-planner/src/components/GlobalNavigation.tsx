...
export default function GlobalNavigation() {
    ...
    if (pathname === "/" || pathname === "/social" || pathname.startsWith("/login") || pathname.startsWith("/planner") || pathname.startsWith("/progress") || pathname.startsWith("/notes") || pathname.startsWith("/quiz") || pathname.startsWith("/settings") || pathname.startsWith("/guide/pmla") || pathname.startsWith("/guide/cpa") || pathname.startsWith("/guide/pli") || pathname.startsWith("/guide/ccs")) return null;
