...
export default function NativeStudyPlanner({
    ...
    return (
        <div className="min-h-screen bg-black text-slate-200 font-sans pb-32">
            ...
            {/* Mode Switcher */}
            <div className="relative z-20 bg-black/95 backdrop-blur-md px-4 py-3 border-b border-white/10 flex gap-2">
                <button
                    onClick={() => setViewMode('recommended')}
                    className={`flex-1 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all ${viewMode === 'recommended' ? 'bg-zinc-800 text-white shadow-sm' : 'text-slate-500'
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex-1 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all ${viewMode === 'flexible' ? 'bg-zinc-800 text-emerald-400 shadow-sm' : 'text-slate-500'
                        }`}
                >
            ...
            {viewMode === 'flexible' ? (
                <div className="px-4 py-4 min-h-[80vh]">
