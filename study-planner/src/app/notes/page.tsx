...
const SCHEDULE_MAPPING: Record<string, string> = {
    ...
    "Schedule of Financial Powers": "09-06-2026",
    "Schedule of Financial Powers of Divisional Heads, Head of the Circle, etc.": "09-06-2026",
...
const PDF_DATA: Record<string, Note[]> = {
    ...
    "Paper III": [
        ...
        // 30. Financial Powers
        {
            ...
            filename: "Schedule_of_Financial_Powers_Study_Notes_Updated_09-06-2026.pdf",
            path: "/notes/paper-3/Schedule_of_Financial_Powers_Study_Notes_Updated_09-06-2026.pdf",
            size: "4.7 MB",
            color: "blue",
            topic: "Financial & Procurement"
        },
            ...
            <div className="bg-slate-50 dark:bg-zinc-950 font-sans text-slate-800 dark:text-zinc-200">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20">
                    ...
                    <div className="mb-8 bg-amber-50 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/50 rounded-2xl py-3 px-4 shadow-sm overflow-hidden relative flex items-center">
                        <div className="shrink-0 bg-red-100 dark:bg-red-900/50 text-red-800 dark:text-red-200 px-3 py-1 rounded-lg text-xs font-black uppercase tracking-widest mr-4 shadow-sm z-10 relative">
                            IMPORTANT
                        </div>
                        <div className="overflow-hidden relative flex-1 mask-linear-fade">
                            <div className="animate-marquee whitespace-nowrap inline-block text-amber-900 dark:text-amber-100 font-medium text-sm md:text-base">
                                ...
                                📢 Aspirants are requested to kindly report any error found in the PDF Notes immediately to WhatsApp No. 9363030396 for prompt correction. Your support helps us maintain the quality and accuracy of our study materials. – Admin, Dak Guru
                            </div>
                        </div>
                        <style jsx>{`
                        @keyframes marquee {
