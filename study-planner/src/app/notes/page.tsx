        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-8 transition-colors">
            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="text-center mb-16">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 dark:bg-red-900/30 mb-8">
                    ...
                    <p className="text-zinc-500 dark:text-zinc-400 text-lg max-w-2xl mx-auto">
                        Official manuals, acts, and rulebooks including printable notes for Inspector Posts Exam 2026.
                    </p>
                </div>
                            ...
                            {PAPER_I_FILES.map((file, idx) => (
                                <div key={idx} className="group flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-blue-50 dark:hover:bg-blue-900/20 border border-zinc-100 dark:border-zinc-700/50 hover:border-blue-100 dark:hover:border-blue-900/30 transition-all">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <a href={`/resources/paper1/${file}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="View">
                                            <Eye className="w-4 h-4" />
                                        </a>
                                        <a href={`/resources/paper1/${file}`} download className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="Download">
                        ...
                        <div className="space-y-3">
                            {PAPER_II_FILES.map((file, idx) => (
                                <div key={idx} className="group flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-purple-50 dark:hover:bg-purple-900/20 border border-zinc-100 dark:border-zinc-700/50 hover:border-purple-100 dark:hover:border-purple-900/30 transition-all">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <a href={`/resources/paper2/${file}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="View">
                                            <Eye className="w-4 h-4" />
                                        </a>
                                        <a href={`/resources/paper2/${file}`} download className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="Download">
                                            <Download className="w-4 h-4" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-3 h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                            {PAPER_III_FILES.map((file, idx) => (
                                <div key={idx} className="group flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 hover:bg-pink-50 dark:hover:bg-pink-900/20 border border-zinc-100 dark:border-zinc-700/50 hover:border-pink-100 dark:hover:border-pink-900/30 transition-all">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <a href={`/resources/paper3/${file}`} target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-pink-600 dark:hover:text-pink-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="View">
                                            <Eye className="w-4 h-4" />
                                        </a>
                                        <a href={`/resources/paper3/${file}`} download className="p-2 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-pink-600 dark:hover:text-pink-400 hover:bg-white dark:hover:bg-zinc-700 transition-colors" title="Download">
                                            <Download className="w-4 h-4" />
                                        </a>
                                    </div>
                                </div>
