    ...
    <div className="sticky top-[57px] z-40 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-2 md:py-3">
                ...
                <div className="grid grid-cols-3 gap-2 md:flex md:justify-center md:space-x-2 bg-zinc-100/50 dark:bg-zinc-900/50 p-1.5 rounded-xl md:bg-transparent md:dark:bg-transparent md:p-0">
                    {['paper1', 'paper2', 'paper3'].map((tab) => (
                        <button
                            key={tab}
                            onClick={() => {
                                setActiveTab(tab);
