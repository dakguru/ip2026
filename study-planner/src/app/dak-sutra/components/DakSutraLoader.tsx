...
export default function DakSutraLoader() {
    return (
        <div className="py-12 md:py-24 min-h-[250px] md:min-h-[400px] flex flex-col items-center justify-center relative overflow-hidden bg-transparent">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150px] h-[150px] md:w-[400px] md:h-[400px] bg-blue-500/10 dark:bg-blue-500/5 rounded-full blur-[40px] md:blur-[60px] animate-pulse" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100px] h-[100px] md:w-[250px] md:h-[250px] bg-violet-600/10 dark:bg-violet-600/5 rounded-full blur-[30px] md:blur-[40px] animate-pulse [animation-delay:1s]" />
            ...
            <div className="relative flex flex-col items-center z-10">
                ...
                <div className="relative w-16 h-16 md:w-32 md:h-32 flex items-center justify-center">
                    ...
                    <div className="w-10 h-10 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white/40 dark:bg-zinc-800/40 backdrop-blur-md border border-white/60 dark:border-white/10 shadow-xl flex items-center justify-center relative hover:scale-105 transition-transform duration-300">
                        <BookOpen className="w-5 h-5 md:w-8 md:h-8 text-blue-600 dark:text-blue-400 animate-pulse" />
                ...
                <div className="mt-4 md:mt-10 flex flex-col items-center">
                    ...
                    <p className="text-zinc-400 dark:text-zinc-500 text-[9px] md:text-xs font-bold uppercase tracking-[0.25em] mt-2 md:mt-3 animate-pulse">
                        Decoding Rules...
                    </p>
                </div>
            </div>
