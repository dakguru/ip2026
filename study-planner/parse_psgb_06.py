...
export const PSGB_MOCK_06_QUESTIONS: Question[] = [
"""
...
"""
    ...
    output_filename = "src/data/psgb_mock_data_06.ts"
    with open(output_filename, 'w', encoding='utf-8') as f:
        f.write(ts_output)

    print(f"Generated {output_filename} with {len(questions)} questions.")

parse_psgb_test(r"D:\IP 2026\PS Gr B - Weekly Mock Test Series\PS Gr B - Weekly Mock Test 06.txt")
