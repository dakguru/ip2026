...
const DIR = path.join(process.cwd(), 'seed-dh-financial-part2');
...
async function seed() {
    ...
    const entry = {
        title: "Divisional Head Financial Powers (Part 2): Printing, Rent for Others, Civil Works, Legal Charges & Refunds",
        slug: "dh-fp-part2",
        rule_number: "Schedule III, Sl. No. 10–14",
        act_name: "DFPR 2024",
        category: "Rule",
    ...
    console.log("Seeding Divisional Head Financial Powers (Part 2)...");
    ...
    console.log("✅ Seed completed! Divisional Head Financial Powers Part 2 is now live.");
    process.exit(0);
}
