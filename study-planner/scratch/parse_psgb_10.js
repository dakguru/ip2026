...
const input = fs.readFileSync('D:\\IP 2026\\PS Gr B - Weekly Mock Test Series\\PS Gr B - Weekly Mock Test 10.txt', 'utf8');
...
let output = `import { Question } from "./live_mock_data";\n\nexport const PSGB_MOCK_10_QUESTIONS: Question[] = ${JSON.stringify(questions, null, 4)};\n`;

fs.writeFileSync('d:\\IP 2026\\study-planner\\src\\data\\psgb_mock_data_10.ts', output);
console.log('Successfully wrote psgb_mock_data_10.ts');
