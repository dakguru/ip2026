...
const input = fs.readFileSync('D:\\IP 2026\\LDCE IP Mock Test Series II\\S2 - 02.txt', 'utf8');
...
let output = `import { Question } from "./live_mock_data";\n\nexport const WEEKLY_MOCK_S2_02_QUESTIONS: Question[] = ${JSON.stringify(questions, null, 4)};\n`;

fs.writeFileSync('d:\\IP 2026\\study-planner\\src\\data\\weekly_mock_data_s2_02.ts', output);
console.log('Successfully wrote weekly_mock_data_s2_02.ts');
