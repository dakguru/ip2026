...
// Data to insert for PS Gr B - Weekly Mock Test 09
const mockData = [
    { name: 'Sivakumar', email: 'sivakumartry.07@gmail.com', score: 194 },
    { name: 'Rajesh Kannan', email: 'kannan.rajesh@gmail.com', score: 190 },
    { name: 'KS Surya', email: 'kss.ipklesubdn@gmail.com', score: 186 },
    { name: 'Vishnu', email: 'vishnuthepostalasst@gmail.com', score: 182 },
    { name: 'M M Kumaran', email: 'mmkumaran.99@gmail.com', score: 180 }
];

const TEST_ID = 'psgb-mock-2026-05-31';
    ...
    try {
        ...
        for (const data of mockData) {
            ...
            if (existingResult) {
                ...
                existingResult.submittedAt = new Date('2026-05-31T15:30:00+05:30'); // realistic submission date
                ...
                const newResult = new MockResult({
                    ...
                    submittedAt: new Date('2026-05-31T15:30:00+05:30'),
                    testId: TEST_ID,
