...
export const WEEKLY_MOCK_07_QUESTIONS: Question[] = [
"""
...
"""
    ...
    output_filename = "src/data/weekly_mock_data_07.ts"
    with open(output_filename, 'w', encoding='utf-8') as f:
        f.write(ts_output)

    print(f"Generated {{output_filename}} with {len(questions)} questions.")

parse_mock_test(r"d:\IP 2026\Mock Test - 07.txt")
