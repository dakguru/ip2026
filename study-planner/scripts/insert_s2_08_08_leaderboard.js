...
const explicitData = [
    ...
    { name: 'KKV', score: 188 },
    { name: 'Mahesh Mandal', score: 186 },
    { name: 'Vishnu Raj', score: 186 },
    { name: 'MR Khanna', score: 182 },
    { name: 'Ravi Teja', score: 180 }
];
...
const randomNames = indianNames.slice(0, 25);

// Marks from 160 to 176
randomNames.forEach(name => {
    mockData.push({
        name: name,
        email: name.toLowerCase() + '@gmail.com',
        score: 160 + Math.floor(Math.random() * 9) * 2 // Even scores between 160 and 176
    });
});

const TEST_ID = 'mock-s2-2026-08-08';
const TOTAL_QUESTIONS = 100;
const SUBMITTED_AT = new Date('2026-08-08T18:30:00+05:30');
    ...
    try {
        ...
        for (const data of mockData) {
            ...
            if (existingResult) {
                ...
                existingResult.submittedAt = SUBMITTED_AT;
