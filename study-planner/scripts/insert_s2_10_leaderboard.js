...
const explicitData = [
    { name: 'KKV', score: 196 },
    { name: 'Rajeshkanna', score: 194 },
    { name: 'Ravi Teja', score: 194 },
    { name: 'Vishnu Raj', score: 192 },
    { name: 'Arun Selvaraj', score: 190 },
...
const TEST_ID = 'mock-s2-2026-08-01';
    ...
    try {
        ...
        for (const data of mockData) {
            ...
            if (existingResult) {
                ...
                existingResult.submittedAt = new Date('2026-08-02T18:30:00+05:30');
                ...
                const newResult = new MockResult({
                    ...
                    submittedAt: new Date('2026-08-02T18:30:00+05:30'),
                    testId: TEST_ID,
