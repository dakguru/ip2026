...
// Define inline schemas to avoid Next.js alias/relative imports in pure Node environment
...
// Data to insert
const mockData = [
    { name: 'Vishnu K', email: 'kvishnuonline@gmail.com', score: 92 },
    { name: 'Krishnakumar', email: 'krishkumar123@gmail.com', score: 90 },
    { name: 'Hariharan R S', email: 'harirscept@gmail.com', score: 86 },
    { name: 'KUMARAN', email: 'kumaranonweb@gmail.com', score: 80 }
];

const TEST_ID = 'psgb-mock-2026-05-17';
    ...
    try {
        ...
        for (const data of mockData) {
            ...
            if (existingResult) {
                ...
                existingResult.submittedAt = new Date('2026-05-17T18:30:00+05:30'); // realistic submission date
                ...
                const newResult = new MockResult({
                    ...
                    submittedAt: new Date('2026-05-17T18:30:00+05:30'),
                    testId: TEST_ID,
