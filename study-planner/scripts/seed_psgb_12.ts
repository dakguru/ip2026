...
const testId = "psgb-mock-2026-06-21";
const data = [
    { score: 180, userName: "Suresh Kumar", userEmail: "sureshkumar@example.com" },
    { score: 180, userName: "RRK", userEmail: "rrk@example.com" },
    { score: 178, userName: "Krishnakumar ASP", userEmail: "krishnakumarasp@example.com" },
    { score: 176, userName: "Rajesh", userEmail: "rajesh@example.com" },
    { score: 174, userName: "Kumararajaa", userEmail: "kumararajaa@example.com" },
    { score: 174, userName: "Vishu", userEmail: "vishu@example.com" }
];
