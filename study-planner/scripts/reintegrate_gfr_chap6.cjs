...
const mcqFile = 'D:\\IP 2026\\MCQs\\GFR Chapter VI.txt';
...
quizzesContent = quizzesContent.replace(/import \{ gfr_chap6_set\d+ \} from '\.\/flashcards\/gfrChapter6';\r?\n/g, '');

// Remove existing ALL_SETS_DATA injections
quizzesContent = quizzesContent.replace(/^\s*\d+:\s*gfr_chap6_set\d+,\r?\n/gm, '');
...
// Find the exact line for psgb-30 and replace its array
