...
const mcqFile = 'D:\\IP 2026\\MCQs\\GFR_2017_NonProcurement_MCQ_Bank.txt';
...
const oldLine = `createTopic('psgb-63', "General Financial Rules 2017 other than public procurement", 'Paper II', [])`;
const newLine = `createTopic('psgb-63', "General Financial Rules 2017 other than public procurement", 'Paper II', [${setIds.join(', ')}])`;
