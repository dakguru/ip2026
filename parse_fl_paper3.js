...
const sets = [
    { num: 1, export: 'FL_PAPER3_SET_01_QUESTIONS', prefix: 'fl-p3-01' },
    { num: 2, export: 'FL_PAPER3_SET_02_QUESTIONS', prefix: 'fl-p3-02' },
    { num: 3, export: 'FL_PAPER3_SET_03_QUESTIONS', prefix: 'fl-p3-03' },
    { num: 4, export: 'FL_PAPER3_SET_04_QUESTIONS', prefix: 'fl-p3-04' },
    { num: 5, export: 'FL_PAPER3_SET_05_QUESTIONS', prefix: 'fl-p3-05' },
];

sets.forEach(s => {
    parseMockTest(
        `D:\\IP 2026\\LDCE IP Mock Test Series II\\Paper III\\Set - ${s.num}.txt`,
        `D:\\IP 2026\\study-planner\\src\\data\\fl_paper3_set_0${s.num}.ts`,
        s.export,
        s.prefix
    );
});
