...
const input = fs.readFileSync('D:\\IP 2026\\LDCE IP Mock Test - 13.txt', 'utf8');
...
let output = `import { Question } from "./live_mock_data";\n\nexport const WEEKLY_MOCK_13_QUESTIONS: Question[] = ${JSON.stringify(questions, null, 4)};\n`;

fs.writeFileSync('d:\\IP 2026\\study-planner\\src\\data\\weekly_mock_data_13.ts', output);
console.log('Done!');
